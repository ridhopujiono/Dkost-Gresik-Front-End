                ...
                <div class="d-flex gap-2">
                    @if (auth()->user())
                        <div class="dropdown" style="cursor: pointer" >
                            <div data-bs-toggle="dropdown" aria-expanded="false" class="d-flex gap-2 align-items-center">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end mt-3 border-0 shadow-sm">
                            ...
                            <li><a class="dropdown-item" href="{{ url('auth/google/logout') }}" style="
                                color: #df6e6e;
                                font-weight: 500;
                            ">Logout <img width="17" height="17"                                           src="https://img.icons8.com/fluency-systems-regular/48/FA5252/logout-rounded.png" alt="logout-rounded"/></a></li>
                          </ul>
                        </div>
                    @else
